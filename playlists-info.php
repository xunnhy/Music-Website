...
?>
<?php
    include "header-img-playlist.php";
    ?>
<?php
    if(isset($_GET['id']))
    {
        ...
        $sql = "SELECT bh.HinhBaiHat, bh.TenBaiHat, bh.NgheSi, bh.idBaiHat FROM baihat bh, playlist pl
        WHERE pl.idPlaylist = bh.idPlaylist AND pl.idPlaylist = '$idPlaylist'";
