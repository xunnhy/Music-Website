...
?>
    <?php
    include "header-img-topchart.php";
    ?>
    <!-- Top-charts info -->
    <?php
    if(isset($_GET['id']))
    {
        ...
        $sql = "SELECT bh.HinhBaiHat, bh.TenBaiHat, bh.NgheSi, bh.idBaiHat FROM baihat bh, theloai tl
        WHERE tl.idTheLoai = bh.idTheLoai AND tl.idTheLoai = '$idTheLoai' ORDER BY LuotThich DESC";
