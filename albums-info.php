...
?>
    ...
    if(isset($_GET['id']))
    {
        ...
        $sql = "SELECT bh.idBaiHat, bh.idAlbum, bh.HinhBaiHat, bh.TenBaiHat, bh.NgheSi, bh.idBaiHat FROM baihat bh, album alb
        WHERE alb.idAlbum = bh.idAlbum AND alb.idAlbum = $idAlbum";
