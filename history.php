...
echo "<h2 class='history-header'>History</h2>";

if (isset($_SESSION['user_id'])) {
    $sql = "SELECT baihat.* FROM history
            INNER JOIN baihat ON history.idBaiHat = baihat.idBaiHat
            WHERE history.id = ".$_SESSION['user_id'];
